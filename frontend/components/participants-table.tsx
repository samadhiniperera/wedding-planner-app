    ...
    <div>
      <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex gap-2">
          <button
            onClick={() => addRow('bride')}
            className="flex flex-1 items-center justify-center gap-1 rounded-lg bg-purple-600 px-3 py-2 text-sm font-medium text-white hover:bg-purple-700 sm:flex-none"
          >
            <Plus size={15} /> Bride&apos;s row
          </button>
          <button
            onClick={() => addRow('groom')}
            className="flex flex-1 items-center justify-center gap-1 rounded-lg bg-blue-600 px-3 py-2 text-sm font-medium text-white hover:bg-blue-700 sm:flex-none"
          >
            <Plus size={15} /> Groom&apos;s row
          </button>
        </div>
      ...
      <p className="mb-2 text-xs text-slate-400 md:hidden">Swipe sideways to see all columns →</p>
